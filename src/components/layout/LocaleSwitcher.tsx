  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="form-select min-h-[2.75rem] border border-warm-100 bg-white py-2 pl-3 pr-9 text-sm font-medium text-ink shadow-card ring-1 ring-inset ring-ink/10 transition-colors hover:ring-ink/20 disabled:opacity-60"
      >
        {locales.map((code) => (
