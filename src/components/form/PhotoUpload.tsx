  ...
  return (
    ...
    >
      <label
        htmlFor="photo"
        className={cn(
          'flex cursor-pointer flex-col items-center justify-center gap-2 border-2 border-dashed border-warm-100 bg-cream-50 px-6 py-8 text-center transition-colors hover:border-accent-400 hover:bg-accent-50',
          isUploading && 'opacity-60',
        )}
      >
        <Icon name="sparkle" className="h-6 w-6 text-warm-700" />
